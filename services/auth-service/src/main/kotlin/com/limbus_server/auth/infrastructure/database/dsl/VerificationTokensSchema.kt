...
// Define el objeto que representa la tabla de tokens de verificación de email en la base de datos.
// Este objeto extiende Table de Exposed y define las columnas de la tabla.
object VerificationTokensSchema : Table("verification_tokens") { // Nombre de la tabla en la base de datos
    // Define las columnas de la tabla
    // id: Clave primaria autoincremental para la tabla de tokens.
    val id = integer("id").autoIncrement()
    // token: El valor único del token de verificación (la cadena).
    ...
    // Un usuario solo debería tener un token de verificación activo a la vez, considera un índice único compuesto si permites múltiples inactivos.
    ...
    // uniqueIndex("uq_user_active_verification_token", userId, isUsed) // Requeriría lógica adicional para manejar `isUsed`

}

// Notas:
// - Este archivo solo define la estructura de la tabla de verification tokens.
// - La lógica de creación, búsqueda, validación y eliminación de tokens
//   residirá en la implementación del repositorio (VerificationTokenRepositoryImpl).
